    ...
    const handleSubmit = async (e) => {
        ...
        if (isRegisterMode) {
            try {
                ...
                if (data.success) {
                    // Passa os dados completos do usuário (incluindo onboarding_completed)
                    onLogin(email, password, data.user);
                } else {
            ...
            <div style={{
                ...
                <div style={{ marginTop: '24px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                        <div style={{ flex: 1, height: '1px', background: '#e4e9f2' }}></div>
                        <span style={{ color: '#9fb3c8', fontSize: '0.8rem', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px' }}>ou</span>
                        <div style={{ flex: 1, height: '1px', background: '#e4e9f2' }}></div>
                    </div>
                    <button
                        type="button"
